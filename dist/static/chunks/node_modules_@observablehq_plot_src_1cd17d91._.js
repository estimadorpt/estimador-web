...
"[project]/node_modules/@observablehq/plot/src/marks/bar.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AbstractBar extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$mark$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mark"] {
    render(index, scales, channels, dimensions, context) {
        const { rx, ry, rx1y1, rx1y2, rx2y1, rx2y2 } = this;
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$context$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])("svg:g", context).call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyIndirectStyles"], this, dimensions, context).call(this._transform, this, scales).call((g)=>g.selectAll().data(index).enter().call(rx1y1 || rx1y2 || rx2y1 || rx2y2 ? (g)=>g.append("path").call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyDirectStyles"], this).call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$marks$2f$rect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyRoundedRect"], x, y, add(x, w), add(y, h), this).call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyChannelStyles"], this, channels) : (g)=>g.append("rect").call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyDirectStyles"], this).attr("x", x).attr("width", w).attr("y", y).attr("height", h).call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyAttr"], "rx", rx).call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyAttr"], "ry", ry).call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyChannelStyles"], this, channels))).node();
    }
    _x(scales, param, param1) {
        let { x: X } = param, { marginLeft } = param1;
        const { insetLeft } = this;
        return X ? (i)=>X[i] + insetLeft : marginLeft + insetLeft;
    }
    _y(scales, param, param1) {
        let { y: Y } = param, { marginTop } = param1;
        const { insetTop } = this;
        return Y ? (i)=>Y[i] + insetTop : marginTop + insetTop;
    }
    _width(param, param1, param2) {
        let { x } = param, { x: X } = param1, { marginRight, marginLeft, width } = param2;
        const { insetLeft, insetRight } = this;
        const bandwidth = X && x ? x.bandwidth() : width - marginRight - marginLeft;
        return Math.max(0, bandwidth - insetLeft - insetRight);
    }
    _height(param, param1, param2) {
        let { y } = param, { y: Y } = param1, { marginTop, marginBottom, height } = param2;
        const { insetTop, insetBottom } = this;
    ...
    constructor(data, channels, options = {}, defaults = barDefaults){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$marks$2f$rect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rectInsets"])(this, options);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$marks$2f$rect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rectRadii"])(this, options);
    }
}
function add(a, b) {
...
class BarX extends AbstractBar {
    _transform(selection, mark, param) {
        let { x } = param;
        selection.call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyTransform"], mark, {
            x
        }, 0, 0);
    }
    _x(param, param1, param2) {
        let { x } = param, { x1: X1, x2: X2 } = param1, { marginLeft } = param2;
        const { insetLeft } = this;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$scales$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCollapsed"])(x) ? marginLeft + insetLeft : (i)=>Math.min(X1[i], X2[i]) + insetLeft;
    }
    _width(param, param1, param2) {
        let { x } = param, { x1: X1, x2: X2 } = param1, { marginRight, marginLeft, width } = param2;
        const { insetLeft, insetRight } = this;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$scales$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCollapsed"])(x) ? width - marginRight - marginLeft - insetLeft - insetRight : (i)=>Math.max(0, Math.abs(X2[i] - X1[i]) - insetLeft - insetRight);
    }
...
class BarY extends AbstractBar {
    ...
    _y(param, param1, param2) {
        let { y } = param, { y1: Y1, y2: Y2 } = param1, { marginTop } = param2;
        const { insetTop } = this;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$scales$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCollapsed"])(y) ? marginTop + insetTop : (i)=>Math.min(Y1[i], Y2[i]) + insetTop;
    }
    _height(param, param1, param2) {
        let { y } = param, { y1: Y1, y2: Y2 } = param1, { marginTop, marginBottom, height } = param2;
        const { insetTop, insetBottom } = this;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$scales$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCollapsed"])(y) ? height - marginTop - marginBottom - insetTop - insetBottom : (i)=>Math.max(0, Math.abs(Y2[i] - Y1[i]) - insetTop - insetBottom);
    }
    constructor(data, options = {}, defaults){
...
function barY(data) {
    ...
    return new BarY(data, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$transforms$2f$stack$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maybeStackY"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$transforms$2f$interval$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maybeIntervalY"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$transforms$2f$identity$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maybeIdentityY"])(options))));
}
}),
"[project]/node_modules/@observablehq/plot/src/marks/cell.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class Cell extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$marks$2f$bar$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AbstractBar"] {
    _transform(selection, mark) {
        // apply dx, dy
        selection.call(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["applyTransform"], mark, {}, 0, 0);
    }
...
function cellX(data) {
    let { x = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$options$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["indexOf"], fill, stroke, ...options } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    if (fill === undefined && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$options$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maybeColorChannel"])(stroke)[0] === undefined) fill = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$options$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["identity"];
    return new Cell(data, {
        ...options,
        x,
        fill,
...
function cellY(data) {
    let { y = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$options$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["indexOf"], fill, stroke, ...options } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    if (fill === undefined && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$options$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maybeColorChannel"])(stroke)[0] === undefined) fill = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$options$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["identity"];
    return new Cell(data, {
        ...options,
        y,
...
//# sourceMappingURL=node_modules_%40observablehq_plot_src_1cd17d91._.js.map