...
"[project]/src/components/charts/SimpleCoalitionDots.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function SimpleCoalitionDots(param) {
    let { data, width = 600, height = 300 } = param;
    _s();
    const containerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SimpleCoalitionDots.useEffect": ()=>{
            if (!data || data.length === 0) return;
            // Calculate coalition seats for each simulation
            const scatterData = data.slice(0, 1000).flatMap({
                "SimpleCoalitionDots.useEffect.scatterData": (simulation, i)=>{
                    const leftSeats = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2f$blocs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["leftBlocParties"].reduce({
                        "SimpleCoalitionDots.useEffect.scatterData.leftSeats": (sum, party)=>sum + (simulation[party] || 0)
                    }["SimpleCoalitionDots.useEffect.scatterData.leftSeats"], 0);
                    const rightSeats = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2f$blocs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rightBlocParties"].reduce({
                        "SimpleCoalitionDots.useEffect.scatterData.rightSeats": (sum, party)=>sum + (simulation[party] || 0)
                    }["SimpleCoalitionDots.useEffect.scatterData.rightSeats"], 0);
                    return [
                        {
                            x: leftSeats,
                            y: 0.2 + i % 50 * 0.01,
            ...
            }["SimpleCoalitionDots.useEffect.scatterData"]);
            ...
            const plot = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$plot$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["plot"]({
                ...
                marks: [
                    ...
                    // Simple dots
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$observablehq$2f$plot$2f$src$2f$marks$2f$dot$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dot"](scatterData, {
                        x: "x",
                        y: "y",
                        fill: "coalition",
                        fillOpacity: 0.6,
            ...
            return ({
                "SimpleCoalitionDots.useEffect": ()=>plot.remove()
            })["SimpleCoalitionDots.useEffect"];
        }
    }["SimpleCoalitionDots.useEffect"], [
        data,
...
_s(SimpleCoalitionDots, "8puyVO4ts1RhCfXUmci3vLI3Njw=");
_c = SimpleCoalitionDots;
var _c;
__turbopack_context__.k.register(_c, "SimpleCoalitionDots");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_d993ed91._.js.map