  ...
  return (
    ...
    >
            ...
            <ul className="divide-y divide-stone-100">
              {decidedTenors.map(([key, tn]) => (
                <li key={key} className="py-2.5 first:pt-0 last:pb-0">
                  ...
                  <div className="mt-0.5 text-[11px] text-stone-400 tabular-nums">
                ...
                return (
                  <li key={key} className="py-2.5 first:pt-0 last:pb-0">
                    ...
                    <div className="mt-1.5 grid grid-cols-3 gap-1.5 text-center">
                      <div className="rounded bg-cream border border-stone-200 px-1 py-1.5">
      ...
      {ctx && isNum(ctx.new_loan_rate_variable_pct?.value) && (
        <p className="mt-1.5 text-[11px] text-stone-400 max-w-prose tabular-nums">
          {t('mortgageContext', {
