...
**This page describes the election models.** Each domain on the site has its own methodology:

- **Elections** — this page
- **Economy** — [economy methodology](/en/economia/metodologia/)
- **Liga Portugal** — [football methodology](/en/desporto/liga/metodologia/) and the [model evaluation](/en/desporto/liga/modelo/)
