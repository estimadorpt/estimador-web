# Metodologia — eleições

**Esta página descreve os modelos eleitorais.** Cada domínio do site tem a sua própria metodologia:

- **Eleições** — esta página
- **Economia** — [metodologia da economia](/pt/economia/metodologia/)
- **Liga Portugal** — [metodologia do futebol](/pt/desporto/liga/metodologia/) e a [avaliação do modelo](/pt/desporto/liga/modelo/)
...
<details>
<summary>**Detalhes Técnicos: Random Walk**</summary>
