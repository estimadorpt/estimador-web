...
export interface PulseAnchorHonesty {
  anchor_claim?: string;
  anchor_claim_i18n?: HonestyNoteI18n;
  tilt_claim_i18n?: HonestyNoteI18n;
  tilt_claim?: string;
...
export interface OfficialQuarterlyTileData {
  ...
  first_release_note_i18n?: HonestyNoteI18n;
